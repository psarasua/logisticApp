// src/components/Dashboard/Dashboard.jsx - VERSIÓN LIMPIA
...
const Dashboard = () => {
  ...
  return (
    // Container completamente limpio - SIN elementos flotantes
    <div className="relative w-full h-full overflow-hidden">
      <div className="p-6 max-w-full">
        <div className="max-w-7xl mx-auto">
          
          {/* Stats Cards - Sin elementos flotantes */}
          <div className="mb-8">
            <StatsCards stats={stats} />
          </div>

          {/* Main Content Grid - Limpio */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            
            {/* Repartos Recientes - Sin widgets flotantes */}
            ...
            {/* Sidebar - Sin elementos problemáticos */}
            <div className="space-y-6">
              
              {/* Camiones Activos - Limpio */}
              ...
              {/* Alertas del Sistema - Sin widgets */}
              <div className="bg-white rounded-xl shadow-lg border border-gray-100">
                <div className="px-6 py-4 border-b border-gray-200">
                  <h3 className="text-lg font-semibold text-gray-900 flex items-center">
                    <svg className="w-5 h-5 text-gray-400 mr-2" fill="currentColor" viewBox="0 0 20 20">
